  ...
  return (
    <Card className="bg-green-50 dark:bg-green-950 border border-green-200 dark:border-green-800">
      ...
      <CardContent>
        ...
        <p className="text-gray-700 dark:text-gray-300">Regular Fish: {fish || 0} 🐟 (${calculateValue(fish, fishPrices['Regular Fish'])})</p>
        <p className="text-gray-700 dark:text-gray-300">Rare Fish: {rareFish || 0} 🐠 (${calculateValue(rareFish, fishPrices['Rare Fish'])})</p>
        <p className="text-gray-700 dark:text-gray-300">Special Fish: {specialFish || 0} 🦈 (${calculateValue(specialFish, fishPrices['Special Fish'])})</p>
